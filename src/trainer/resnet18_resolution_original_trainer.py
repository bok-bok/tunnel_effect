...
def train(model, device, train_dataset, test_dataset):
    ...
    save_dir = f"weights/resnet18_resolutions_original/{image_resolution}/{str(learning_rate)}/{str(weight_decay)}"
...
if __name__ == "__main__":
    image_resolution, batch_size, device = parser()
    class_num = 100
